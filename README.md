...
## Data 
Dat for this project is provided by Udacity. It has provided [baseline data](Data/baseline_values.csv)  meassured at the start of the experiment as the reference point for comparison. The data collected for [control group](Data/control.csv) and [experiment group](Data/Experiment.csv) are provided in seperate datasets in order to conduct the A/B test.
